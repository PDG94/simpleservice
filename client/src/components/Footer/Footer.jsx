...
export default function Footer() {
  return (
    <footer className="containerpadre">
      ...
      <h1 className="h1footer animate__animated animate__bounceIn animate__slower animate__infinite">Simple Service </h1>
          <p className="footerP">
            Simple Service is a project developed by advanced Henry'students. 
						It was released on March 2023, with the main objective of
						 providing a platform where costumers can find the best service
						for their needs. To be able to purchase , it is neccesary to be registered
        ...
        <div className="socials">
          ...
          <div className="boxFooter">
            ...
            <a className="ia" href="https://www.linkedin.com/in/magali-ruiz-diaz-25b768265/">
          ...
          <div className="boxFooter">
            ...
            <a className="ia" href="https://www.linkedin.com/in/ayelen-llampa1988/">
                <BsLinkedin className="i" size={45} /></a>
              </div>
          </div >
          ...
          <div className="boxFooter">
            ...
            <a className="ia" href="https://www.linkedin.com/in/luciana-heredia-4b8622198/">
                <BsLinkedin className="i" size={45} /></a>
              </div>
          </div >
          ...
          <div className="boxFooter">
            ...
            <a className="ia" href="https://www.linkedin.com/in/pedro-gonzalez-4468ba24a/">
                <BsLinkedin className="i" size={45} /></a>
              </div>
          </div >
...
/*
 <div className="col-12 justify-content-center text-center">All Rights Reserved</div> 
 */